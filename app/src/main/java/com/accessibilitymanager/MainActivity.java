...
public class MainActivity extends Activity {
    ...
    private String removeServiceFromList(String list, ComponentName serviceComponent) {
        if (list == null || list.isEmpty() || serviceComponent == null) return "";
    ...
    private void switchToTab(boolean isFavorites) {
        ...
        boolean effectivelyFavorites = isFavorites;
    ...
    private void updateTitleView() {
        int textColor = night ? android.graphics.Color.WHITE : android.graphics.Color.BLACK;
        ...
        if (mTitleView != null) {
            ...
            androidx.appcompat.widget.Toolbar.LayoutParams layoutParams = (androidx.appcompat.widget.Toolbar.LayoutParams) mTitleView.getLayoutParams();
            if (layoutParams != null) {
                layoutParams.width = androidx.appcompat.widget.Toolbar.LayoutParams.WRAP_CONTENT;
                mTitleView.setLayoutParams(layoutParams);
            }
        }
        if (mTitleText != null) {
            android.widget.LinearLayout.LayoutParams textParams = (android.widget.LinearLayout.LayoutParams) mTitleText.getLayoutParams();
            if (textParams != null) {
                textParams.width = android.widget.LinearLayout.LayoutParams.WRAP_CONTENT;
                textParams.weight = 0;
    ...
    public class ServiceListAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder rawHolder, int position) {
            ...
            holder.cardView.setOnClickListener(view -> {
                ...
                String event = "";
                if ((eve & 16777216) != 0) event += "当前正在阅读用户屏幕上下文的助理事件\n";
                if ((eve & 8388608) != 0) event += "点击控件上下文的事件\n";
                if ((eve & 4194304) != 0) event += "窗口更改的事件\n";
                if ((eve & 2097152) != 0) event += "用户结束触摸屏幕的事件\n";
                if ((eve & 1048576) != 0) event += "用户开始触摸屏幕的事件\n";
                if ((eve & 524288) != 0) event += "结束手势检测的事件\n";
                if ((eve & 262144) != 0) event += "开始手势检测事件\n";
                if ((eve & 131072) != 0) event += "遍历视图文本事件\n";
                if ((eve & 65536) != 0) event += "清除可访问性焦点事件\n";
                if ((eve & 32768) != 0) event += "获得可访问性焦点的事件\n";
                if ((eve & 16384) != 0) event += "发布公告的应用程序的事件\n";
                if ((eve & 8192) != 0) event += "更改选中文本的事件\n";
                if ((eve & 4096) != 0) event += "滚动视图的事件\n";
                if ((eve & 2048) != 0) event += "窗口内容更改的事件\n";
                if ((eve & 1024) != 0) event += "结束触摸探索手势的事件\n";
                if ((eve & 512) != 0) event += "开始触摸探索手势的事件\n";
                if ((eve & 256) != 0) event += "控件结束文字输入事件\n";
                if ((eve & 128) != 0) event += "控件接受文字输入事件\n";
                if ((eve & 64) != 0) event += "通知状态改变的事件\n";
                if ((eve & 32) != 0) event += "窗口状态更改的事件\n";
                if ((eve & 16) != 0) event += "文本框的文字改变事件\n";
                if ((eve & 8) != 0) event += "控件获得焦点的事件\n";
                if ((eve & 4) != 0) event += "控件被选取的事件\n";
                if ((eve & 2) != 0) event += "长按控件的事件\n";
                if ((eve & 1) != 0) event += "点击控件的事件\n";
